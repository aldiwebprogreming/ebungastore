 ...
 class Ebunga extends CI_Controller
 {
  ...
  function produk(){
       ...
       $this->db->select('nama_produk');
        ...
        $data['papanbunga'] = $this->db->get_where('tbl_produk',['kategori_produk' => 'papan-bunga'])->result_array();

         $data['bunga'] = $this->db->get_where('tbl_produk',['kategori_produk' => 'bunga'])->result_array();

          $data['cake'] = $this->db->get_where('tbl_produk',['kategori_produk' => 'cake'])->result_array();

         $this->load->view('templateuser/header');
         $this->load->view('user/produk.php', $data);
         $this->load->view('templateuser/footer');
  }
